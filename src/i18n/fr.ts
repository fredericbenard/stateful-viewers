export const fr = {
  ...
  onboarding: {
    ...
    nextStepGenerateOrLoadStyle: "Prochaine étape : générez ou chargez un style de réflexion.",
    nextStepGenerateOrLoadState: "Prochaine étape : générez ou chargez un état.",
  ...
  errors: {
    ...
    failedSaveStyle:
      "Génération réussie, mais impossible d’enregistrer le style. En local, redémarrez `npm run dev` pour activer les derniers endpoints de sauvegarde.",
    failedSaveState:
  ...
  sidebar: {
    ...
    untitledStyle: "Style sans titre",
