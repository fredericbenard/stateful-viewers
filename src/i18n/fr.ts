export const fr = {
  ...
  status: {
    generatingProfile: "Génération du profil",
    generatingReflectionStyle: "Génération de la voix",
    generatingInitialState: "Génération de l'état",
    generatingLabel: "Génération de l'étiquette",
    generatingSummaries: "Génération du résumé",
  ...
  errors: {
    ...
    failedGenerateReflectionStyle: "Impossible de générer la voix : {error}",
    failedGenerateInitialState: "Impossible de générer l'état initial : {error}",
    failedSaveProfile:
      "Génération réussie, mais impossible d’enregistrer le profil. En local, redémarrez `npm run dev` pour activer les derniers endpoints de sauvegarde.",
    failedSaveStyle:
      "Génération réussie, mais impossible d’enregistrer la voix. En local, redémarrez `npm run dev` pour activer les derniers endpoints de sauvegarde.",
    failedSaveState:
      "Génération réussie, mais impossible d’enregistrer l'état initial. En local, redémarrez `npm run dev` pour activer les derniers endpoints de sauvegarde.",
