export const en = {
  ...
  status: {
    generatingProfile: "Generating profile",
    generatingReflectionStyle: "Generating voice",
    generatingInitialState: "Generating state",
    generatingLabel: "Generating label",
    generatingSummaries: "Generating summary",
    saving: "Saving",
  },
  errors: {
    apiKeyRequired:
    ...
    failedGenerateReflectionStyle: "Failed to generate voice: {error}",
    failedGenerateInitialState: "Failed to generate initial state: {error}",
    failedSaveProfile:
      "Generated successfully, but couldn't save the profile. If you're running locally, restart `npm run dev` to enable the latest save endpoints.",
    failedSaveStyle:
      "Generated successfully, but couldn't save the voice. If you're running locally, restart `npm run dev` to enable the latest save endpoints.",
    failedSaveState:
      "Generated successfully, but couldn't save the initial state. If you're running locally, restart `npm run dev` to enable the latest save endpoints.",
