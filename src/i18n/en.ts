export const en = {
  ...
  sidebar: {
    ...
    showViewerControls: "Show settings",
    hideViewerControls: "Hide settings",
    viewer: "Viewer",
    viewerCaption: "Profile · Voice · Internal state",
    viewerCaptionModel: "Model: {value}",
    viewerCaptionProfile: "Profile: {value}",
    viewerCaptionStyle: "Reflection style: {value}",
    viewerCaptionState: "Initial state: {value}",
    load: "Load",
    hide: "Hide",
    generate: "Create",
