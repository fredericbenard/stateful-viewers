export const en = {
  ...
  onboarding: {
    ...
    nextStepGenerateOrLoadStyle: "Next step: select a voice.",
  ...
  status: {
    generatingProfile: "Creating profile",
    generatingReflectionStyle: "Creating voice",
  ...
  errors: {
    ...
    failedGenerateReflectionStyle: "Failed to create voice: {error}",
    ...
    failedSaveStyle:
      "Created successfully, but couldn't save the voice. If you're running locally, restart `npm run dev` to enable the latest save endpoints.",
    failedSaveState:
