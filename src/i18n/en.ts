export const en = {
  ...
  onboarding: {
    ...
    nextStepGenerateOrLoadStyle: "Next step: generate or load a reflection style.",
    nextStepGenerateOrLoadState: "Next step: generate or load a state.",
  ...
  errors: {
    ...
    failedSaveStyle:
      "Generated successfully, but couldn't save the style. If you're running locally, restart `npm run dev` to enable the latest save endpoints.",
    failedSaveState:
