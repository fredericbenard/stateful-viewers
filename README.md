...
- **Public & Saved viewer artifacts** -- Load pre-generated public artifacts (tracked in git) and/or your own saved ones. Lists are filtered by locale (EN/FR), but not by LLM provider — you can mix a profile generated by one LLM with reflections from another (and a style/state generated elsewhere).
...
# Anthropic / Claude
npx tsx scripts/generate-profiles.ts 3 --llm anthropic --model claude-sonnet-4-5-20250929
